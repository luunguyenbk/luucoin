...
uint256 hashGenesisBlock("0xc348aa84163f962d7e5ad29fdd643ca6836db744522a2b27f4e4bbbb3c9f353b");
...
const string strMessageMagic = "LuuCoin Signed Message:\n";
...
{
    int64 nSubsidy = 1 * COIN; //Amt of coins per block
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // LuuCoin: 0.35 days
static const int64 nTargetSpacing = 15; // LuuCoin: 15 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal LuuCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "LuuCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x08d5436224b7b6224dd4cec0071720a058d0b928c778b9e9fa5747a6f8cd99e0");
    }
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        // Genesis block
        const char* pszTimestamp = "First day of Project LuuCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1505569066;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086749864;

        if (fTestNet)
        {
            block.nTime    = 1505554178;
            block.nNonce   = 387997232;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x20c3c6933f6a04f3280f411444b54607da8c950325b5dd490ec9d075289aa403"));
